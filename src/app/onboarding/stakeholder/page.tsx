...
export default function StakeholderOnboardingPage() {
  ...
  const validateStep = (stepNumber: number) => {
    ...
    if (stepNumber === 1) {
      ...
      if (!formData.expertiseAreas.length) newErrors.expertiseAreas = "Please select at least one area of expertise";
    }
  ...
  const renderStep1 = () => (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-gray-600 mb-3">Select all areas where you can provide expertise or guidance to startups</p>
        ...
        {errors.expertiseAreas && <p className="text-red-500 text-sm mt-1">{errors.expertiseAreas}</p>}
      </div>

      <div>
        <Label>Medical Specialties (Optional)</Label>
        <p className="text-sm text-gray-600 mb-3">Add specific medical specialties or sub-specializations</p>
  ...
  const renderStep2 = () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-600 mb-3">What resources can you provide or help startups access?</p>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-2 max-h-64 overflow-y-auto">
      ...
      <div>
        ...
        <p className="text-sm text-gray-600 mb-3">What types of projects or collaborations interest you most?</p>
        <div className="flex gap-2 mb-3">
          <Input
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50 p-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-8">
          <Link href="/onboarding" className="inline-flex items-center text-green-600 hover:text-green-700 mb-4">
          ...
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <span className="font-bold text-xl text-gray-900">MUSC Stakeholder Onboarding</span>
          </div>
          <div className="flex items-center justify-center space-x-2 mb-4">
